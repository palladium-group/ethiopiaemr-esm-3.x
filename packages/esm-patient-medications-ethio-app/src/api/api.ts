...
const customRepresentation =
  ...
  'orderType:ref,encounter:(uuid,display,visit,encounterDatetime),orderer:(uuid,display,person:(display)),orderReason,orderReasonNonCoded,orderType,urgency,instructions,' +
