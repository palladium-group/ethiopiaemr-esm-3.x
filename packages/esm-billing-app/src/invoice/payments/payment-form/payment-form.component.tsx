        ...
        <div key={field.id} className={styles.paymentMethodContainer}>
          <Controller
            ...
            render={({ field: controllerField }) => {
              // Normalize the value to use the exact object reference from paymentModes array
              // This ensures Carbon Dropdown can match it using strict equality (===)
              const normalizedValue = controllerField.value?.uuid
                ? paymentModes?.find((mode) => mode.uuid === controllerField.value?.uuid) || controllerField.value
              ...
              return (
                <Dropdown
                  ...
                  onChange={({ selectedItem }) => {
                    ...
                    controllerField.onChange(selectedItem);
                  }}
