...
const ServiceAvailableDashboardContainer: React.FC = () => {
  const params = useParams();
  const assignedExtensions = useAssignedExtensions('services-available-admin-dashboard-slot');
...
export default ServiceAvailableDashboardContainer;
