...
export const mockFhirPatient = mockPatient as unknown as fhir.Patient;
...
const weeks = {
  uuid: '1073AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA',
  display: 'Weeks',
};
...
const aspirinConcept = {
  ...
  datatype: { uuid: '8d4a4c94-c2cc-11de-8d13-0010c6dffd0f', display: 'N/A' },
  conceptClass: { uuid: '8d490dfc-c2cc-11de-8d13-0010c6dffd0f', display: 'Drug' },
  set: false,
  retired: false,
};

const acetaminophenConcept = {
  ...
  '09e58895-e7f0-4649-b7c0-e665c5c08e93': [
    {
      ...
      template: {
        ...
        dosingInstructions: {
          ...
          route: [{ value: 'oral', valueCoded: oral.uuid, default: true }],
          frequency: [
            {
              value: 'twice daily',
          ...
          instructions: [{ value: 'with or without food', default: true }],
        },
      },
      retired: false,
      drug: {
...
export const mockPatientDrugOrdersApiData = [
  {
    ...
    dosingType: 'org.openmrs.SimpleDosingInstructions',
    orderNumber: 'ORD-814',
    patient: { uuid: patientUuid, display: '1003Y2M - John172 Smith9591' },
    action: 'NEW',
  ...
  },
  {
    ...
    drug: {
      ...
      concept: {
        ...
        name: { display: 'Sulfacetamide', name: 'Sulfacetamide', locale: 'en', localePreferred: true },
        datatype: { uuid: '8d4a4c94-c2cc-11de-8d13-0010c6dffd0f', display: 'N/A' },
        conceptClass: { uuid: '8d490dfc-c2cc-11de-8d13-0010c6dffd0f', display: 'Drug' },
        set: false,
        retired: false,
    ...
    dose: 1,
    doseUnits: application,
    asNeeded: false,
    quantity: 8,
    quantityUnits: application,
    numRefills: 1,
